    ...
    <div>
      <div className="w-full pt-5 flex price-input">
        ...
        <div className="h-10 w-full flex items-center field">
          <input
            type="number"
            className="w-full py-2 shadow appearance-none 
            border border-gray-300 text-gray-700 focus:outline-none
             focus:ring-1 focus:ring-red-400 focus:border-red-400 rounded ml-2 input-max"
            value={maxValue}
          />
        </div>
      </div>
